...
//                 const p = projects.find(x => x.id === v);
//                 set("project_id", v);
//                 if (p) set("project_type", p.project_type);
//               }}>
//                 <SelectTrigger><SelectValue placeholder="Select project" /></SelectTrigger>
//                 <SelectContent>
//                   {projects.map(p => <SelectItem key={p.id} value={p.id}>{p.name}</SelectItem>)}
...
//             <div className="space-y-1.5">
//               <Label>Geography *</Label>
//               <Input value={form.geography} onChange={e => set("geography", e.target.value)} placeholder="e.g. South Africa" />
//             </div>
//             <div className="space-y-1.5">
//               <Label>Manager *</Label>
//               {managers.length > 0 ? (
...
//               </div>
//             )}
//             {form.user_name && form.user_email && managers.find(m => m.email === form.user_email) && (
//               <div className="bg-indigo-50 border border-indigo-100 rounded-lg px-3 py-2 text-sm text-indigo-700">
//                 <span className="font-medium">{form.user_name}</span> · {form.user_email}
//               </div>
//             )}
